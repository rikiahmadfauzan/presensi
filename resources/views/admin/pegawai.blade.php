...
@section('content')
    <section>
        ...
        @endif
        <!-- Modal -->
        <button type="button" class="btn btn-danger mt-2 btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">
            Tambah Data
        </button>
        <!-- Modal -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="forms-sample" action="/create/register" method="post"
                            ...
                            <button type="submit" class="btn btn-danger col-12 me-2">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
